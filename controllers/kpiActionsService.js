// --- Diccionario de acciones recomendadas por KPI + semáforo ---
// Fuente única usada tanto por el PDF del Plan de Acción (planController.js)
// como por los mensajes de diagnóstico en cada sección (dashboardController.js).
...
const planesIntegrados = [
    ...
    },
    {
        ...
        prioridad: "Urgente",
        condiciones: [ ["crecimiento_mom_ROJO"], ["tasa_cobro_efectivo_AMARILLO", "tasa_cobro_efectivo_ROJO"] ],
...
// Evalúa los items de /api/kpis-query y arma la lista final de acciones
// (combinaciones integradas + KPIs individuales), igual que el PDF del Plan de Acción.
function calcularPlanFinal(kpiItems) {
