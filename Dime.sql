...
CREATE TABLE IF NOT EXISTS vendedor (
    ...
    -- Datos de autenticación en la plataforma DiME
    email VARCHAR(255) NOT NULL UNIQUE, -- Correo electrónico del vendedor (único en el sistema)
    password_hash VARCHAR(255) NOT NULL DEFAULT '', -- Hash de la contraseña del vendedor (bcrypt)
    
    -- Datos de conexión con Mercado Libre
    ...
    -- Soft delete (soporte para eliminación lógica)
...
-- ==============================================================================
-- Propósito: Almacena los refresh tokens ya utilizados para evitar
-- su reutilización (protección contra ataques de re-play).
...
--   contacto@techguru.com.ar       / DiMe2024!
--   hola@homedecoar.com           / DiMe2024!
--   soporte@gamingar.com.ar       / DiMe2024!
--   ventas@modamx.com.mx          / DiMe2024!
--   contacto@repuestosmx.com      / DiMe2024!
--   ventas@ferreteriamx.com       / DiMe2024!
--   contato@brasilsports.com.br   / DiMe2024!
--   sac@belezabr.com              / DiMe2024!
--   atendimento@calcados.br       / DiMe2024!
--   info@cafecolombia.co          / DiMe2024!
--   pedidos@juguetesco.com        / DiMe2024!
--   hola@mascotasco.com           / DiMe2024!
--   ventas@chilewines.cl          / DiMe2024!
--   contacto@libroscl.com         / DiMe2024!
--   ventas@deportescl.com         / DiMe2024!
--   sales@ve-electronics.com      / DiMe2024!
--   info@ropave.com               / DiMe2024!
--   admin@tecnoglobal.ve          / DiMe2024!
...
('tech_guru_ar', 'Tech Guru Argentina', 'AR', 'ARS', 3, 'contacto@techguru.com.ar', '$2b$04$x3NfxrAuIWroBS.ZZjAL4OVcYtwvMK36WMkY8OqCnARSfJVSo02oe', 'acc_tk_01', 'ref_tk_01', CURRENT_TIMESTAMP, true),
('home_deco_ar', 'Home & Deco Baires', 'AR', 'ARS', 2, 'hola@homedecoar.com', '$2b$04$x3NfxrAuIWroBS.ZZjAL4OVcYtwvMK36WMkY8OqCnARSfJVSo02oe', 'acc_tk_02', 'ref_tk_02', CURRENT_TIMESTAMP, true),
('gaming_ar', 'Gaming Store AR', 'AR', 'ARS', 1, 'soporte@gamingar.com.ar', '$2b$04$x3NfxrAuIWroBS.ZZjAL4OVcYtwvMK36WMkY8OqCnARSfJVSo02oe', 'acc_tk_03', 'ref_tk_03', CURRENT_TIMESTAMP, true),
...
('moda_mx_oficial', 'Moda MX Oficial', 'MX', 'MXN', 2, 'ventas@modamx.com.mx', '$2b$04$x3NfxrAuIWroBS.ZZjAL4OVcYtwvMK36WMkY8OqCnARSfJVSo02oe', 'acc_tk_04', 'ref_tk_04', CURRENT_TIMESTAMP, true),
('autos_repuestos_mx', 'Repuestos Automotrices MX', 'MX', 'MXN', 3, 'contacto@repuestosmx.com', '$2b$04$x3NfxrAuIWroBS.ZZjAL4OVcYtwvMK36WMkY8OqCnARSfJVSo02oe', 'acc_tk_05', 'ref_tk_05', CURRENT_TIMESTAMP, true),
('ferreteria_mx', 'La Gran Ferretería', 'MX', 'MXN', 2, 'ventas@ferreteriamx.com', '$2b$04$x3NfxrAuIWroBS.ZZjAL4OVcYtwvMK36WMkY8OqCnARSfJVSo02oe', 'acc_tk_06', 'ref_tk_06', CURRENT_TIMESTAMP, false), -- Vendedor inactivo (prueba)

-- Vendedores de Brasil (BR / BRL)
('brasil_sports', 'Brasil Sports SA', 'BR', 'BRL', 1, 'contato@brasilsports.com.br', '$2b$04$x3NfxrAuIWroBS.ZZjAL4OVcYtwvMK36WMkY8OqCnARSfJVSo02oe', 'acc_tk_07', 'ref_tk_07', CURRENT_TIMESTAMP, true),
('beleza_br', 'Beleza Store Brasil', 'BR', 'BRL', 2, 'sac@belezabr.com', '$2b$04$x3NfxrAuIWroBS.ZZjAL4OVcYtwvMK36WMkY8OqCnARSfJVSo02oe', 'acc_tk_08', 'ref_tk_08', CURRENT_TIMESTAMP, true),
('calcados_br', 'Sapatos e Cia', 'BR', 'BRL', 3, 'atendimento@calcados.br', '$2b$04$x3NfxrAuIWroBS.ZZjAL4OVcYtwvMK36WMkY8OqCnARSfJVSo02oe', 'acc_tk_09', 'ref_tk_09', CURRENT_TIMESTAMP, true),

-- Vendedores de Colombia (CO / COP)
('colombia_coffee', 'Café de Colombia Shop', 'CO', 'COP', 2, 'info@cafecolombia.co', '$2b$04$x3NfxrAuIWroBS.ZZjAL4OVcYtwvMK36WMkY8OqCnARSfJVSo02oe', 'acc_tk_10', 'ref_tk_10', CURRENT_TIMESTAMP, true),
('juguetes_co', 'Juguetería Bogotá', 'CO', 'COP', 1, 'pedidos@juguetesco.com', '$2b$04$x3NfxrAuIWroBS.ZZjAL4OVcYtwvMK36WMkY8OqCnARSfJVSo02oe', 'acc_tk_11', 'ref_tk_11', CURRENT_TIMESTAMP, true),
('mascotas_co', 'Mascotas Felices CO', 'CO', 'COP', 1, 'hola@mascotasco.com', '$2b$04$x3NfxrAuIWroBS.ZZjAL4OVcYtwvMK36WMkY8OqCnARSfJVSo02oe', 'acc_tk_12', 'ref_tk_12', CURRENT_TIMESTAMP, true),

-- Vendedores de Chile (CL / CLP)
('chile_wines', 'Vinos Chilenos Premium', 'CL', 'CLP', 3, 'ventas@chilewines.cl', '$2b$04$x3NfxrAuIWroBS.ZZjAL4OVcYtwvMK36WMkY8OqCnARSfJVSo02oe', 'acc_tk_13', 'ref_tk_13', CURRENT_TIMESTAMP, true),
('libros_cl', 'Librería Santiago', 'CL', 'CLP', 2, 'contacto@libroscl.com', '$2b$04$x3NfxrAuIWroBS.ZZjAL4OVcYtwvMK36WMkY8OqCnARSfJVSo02oe', 'acc_tk_14', 'ref_tk_14', CURRENT_TIMESTAMP, true),
('deportes_cl', 'Deportes Extremos CL', 'CL', 'CLP', 2, 'ventas@deportescl.com', '$2b$04$x3NfxrAuIWroBS.ZZjAL4OVcYtwvMK36WMkY8OqCnARSfJVSo02oe', 'acc_tk_15', 'ref_tk_15', CURRENT_TIMESTAMP, true),

-- Vendedores de Venezuela (VE / USD)
-- Venezuela usa USD porque el Bolívar (VES) no es práctico para transacciones digitales
('ve_electronics', 'Venezuela Electronics', 'VE', 'USD', 1, 'sales@ve-electronics.com', '$2b$04$x3NfxrAuIWroBS.ZZjAL4OVcYtwvMK36WMkY8OqCnARSfJVSo02oe', 'acc_tk_16', 'ref_tk_16', CURRENT_TIMESTAMP, true),
('ropa_ve', 'Boutique Caracas', 'VE', 'USD', 1, 'info@ropave.com', '$2b$04$x3NfxrAuIWroBS.ZZjAL4OVcYtwvMK36WMkY8OqCnARSfJVSo02oe', 'acc_tk_17', 'ref_tk_17', CURRENT_TIMESTAMP, true),
('tecnologia_global_ve', 'Tecno Global VE', 'VE', 'USD', 3, 'admin@tecnoglobal.ve', '$2b$04$x3NfxrAuIWroBS.ZZjAL4OVcYtwvMK36WMkY8OqCnARSfJVSo02oe', 'acc_tk_18', 'ref_tk_18', CURRENT_TIMESTAMP, true);
