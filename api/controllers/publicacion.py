...
async def list_publicacions(
    ...
    search: Optional[str] = Query(None, description="Buscar en: ml_item_id, titulo, tipo_publicacion, estado_publicacion"),
    sort_by: Optional[str] = Query(None, description="Ordenar por: id_publicacion, id_vendedor, ml_item_id, titulo, tipo_publicacion, estado_publicacion"),
